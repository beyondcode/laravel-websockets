...
If you are not yet familiar with the concept of Broadcasting in Laravel, please take a look at the [Laravel documentation](https://laravel.com/docs/9.0/broadcasting).
...
The Laravel WebSockets package integrates nicely into [Laravel Echo](https://laravel.com/docs/9.x/broadcasting#receiving-broadcasts) to integrate into your frontend application and receive broadcasted events.
If you are new to Laravel Echo, be sure to take a look at the [official documentation](https://laravel.com/docs/9.x/broadcasting#receiving-broadcasts).
...
Now you can use all Laravel Echo features in combination with Laravel WebSockets, such as [Presence Channels](https://laravel.com/docs/9.x/broadcasting#presence-channels), [Notifications](https://laravel.com/docs/9.x/broadcasting#notifications) and [Client Events](https://laravel.com/docs/9.x/broadcasting#client-events).
